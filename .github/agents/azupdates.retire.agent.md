...
1. Use #tool:azure-updates-mcp/search_azure_updates to search for the retirement update the user is referring to. Ensure you identify an exact set of updates the user is looking for. If no update can be identified, inform the user accordingly.
